...
const bogContainer = document.querySelector(".bog_folder");
const bogBillede = document.querySelector(".bog_billede");
...
bogContainer.addEventListener("dblclick", () => {
  bogBillede.style.display = "block";
});
